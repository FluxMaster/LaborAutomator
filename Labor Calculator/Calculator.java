...
public class Calculator
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		try
		{
			...
			try
			{	
				//Scan assigned job list "#person,name,day,time,length,type"
		...
		catch(Exception e)
		{
			...
			System.out.println("Moving on without it.");
			*/
			CalculatorGUI.infoBox("No AssignedJobs.csv was found in the Jobs folder.\nThe Program will move on without it.","No AssignedJobs.csv found");
